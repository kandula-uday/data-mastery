...
Tests individual transformation logic with sample data
...
# Add notebooks directory to path so we can import transformation functions
...
# Import the transform_to_silver function from 02_silver_transformation.py
...
def test_deduplication_removes_exact_duplicates(spark):
    ...
    test_data = [
        # Record 1: Original
        (datetime(2023, 1, 15, 10, 0), datetime(2023, 1, 15, 10, 15), 
         1, 2.5, 40.7589, -73.9851, 40.7614, -73.9776,
        ...
        (datetime(2023, 1, 15, 11, 0), datetime(2023, 1, 15, 11, 20),
         2, 3.2, 40.7128, -74.0060, 40.7580, -73.9855,
    ...
    # ACT: Run the transformation (using the imported function from top of file)
...
def test_negative_fares_are_filtered(spark):
    ...
    test_data = [
        ...
        (datetime(2023, 1, 15, 11, 0), datetime(2023, 1, 15, 11, 20),
         1, 3.0, 40.7128, -74.0060, 40.7580, -73.9855,
    ...
    # ACT: Run transformation (using the imported function from top of file)
    silver_df = transform_to_silver(bronze_df)
...
def test_zero_distance_trips_filtered(spark):
    ...
    test_data = [
        ...
        (datetime(2023, 1, 15, 11, 0), datetime(2023, 1, 15, 11, 5),
         1, 0.0, 40.7589, -73.9851, 40.7589, -73.9851,
